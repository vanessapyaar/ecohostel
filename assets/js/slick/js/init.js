                ...
                $slick.each(function(){
                    ...
                    if ($this.attr('data-height')) {
                        ...
                        if ($slickheight.indexOf("%") > -1) {
                            $this.css('min-height', $deviceheight * (parseInt($slickheight, 10) / 100));
                            $this.find('.slick-list').css('min-height', $deviceheight * (parseInt($slickheight, 10) / 100));
                            $this.find('.slick-track').css('min-height', $deviceheight * (parseInt($slickheight, 10) / 100));
